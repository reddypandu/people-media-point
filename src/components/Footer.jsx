        ...
        <div className="footer-grid">
          ...
          <div className="footer-col brand-col">
            ...
            <p className="footer-brand-desc">
              <TranslatedText>
                People Media Point is your trusted 24x7 Telugu news destination
                bringing real-time breaking news, politics, district updates,
                cinema buzz, and sports.
              </TranslatedText>
            </p>
          ...
          <div className="footer-col">
            ...
            <ul className="footer-links-list">
              <li>
                <Link to="/latest-news">
                  <TranslatedText>Latest News</TranslatedText>
                </Link>
              </li>
              <li>
                <Link to="/telangana">
              ...
              <li>
                <Link to="/andhra-pradesh">
                  <TranslatedText>Andhra Pradesh</TranslatedText>
                </Link>
              </li>
              <li>
                <Link to="/politics">
                  <TranslatedText>Politics</TranslatedText>
                </Link>
              </li>
              <li>
                <Link to="/movie">
                  <TranslatedText>Cinema Buzz</TranslatedText>
                </Link>
              </li>
              <li>
                <Link to="/crime">
                  <TranslatedText>Crime Radar</TranslatedText>
                </Link>
              </li>
              <li>
                <Link to="/sports">
                  <TranslatedText>Sports</TranslatedText>
                </Link>
              </li>
              <li>
                <Link to="/technology">
                  <TranslatedText>Technology</TranslatedText>
                </Link>
              </li>
            </ul>
          </div>
          ...
          <div className="footer-col">
            ...
            <ul className="footer-links-list" style={{ gap: "0.8rem" }}>
              ...
              >
                <MapPin
                  size={16}
                  style={{ flexShrink: 0, marginTop: "2px", color: "#D32F2F" }}
                />
                <span>
                  Eureka court complex, B9, 3rd floor, beside image hospital,
                  Ameerpet, hyderabad.
                </span>
              </li>
              <li
